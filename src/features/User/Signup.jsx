    ...
    >
      <div className="py-2 bg-indigo-100 lg:bg-white flex justify-center lg:justify-start lg:px-12">
        <NavLink to="/" className="cursor-pointer flex items-center">
          ...
          <div className="text-xl text-indigo-800 tracking-wide ml-2 font-semibold">
            CYBERSOFT
          </div>
        </NavLink>
      </div>
      <div className="px-12 sm:px-24 md:px-48 lg:px-12 xl:px-24 xl:max-w-2xl">
        <h2
          className="text-center text-3xl text-indigo-900 font-display font-semibold lg:text-left xl:text-3xl
xl:text-bold"
        >
          ĐĂNG KÝ
        </h2>
